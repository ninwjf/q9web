...
iosClient = APNsClient(
    'developent2.pem', use_sandbox=CONFIG.DEBUG, heartbeat_period=600)


def pushIOS(notifications):
    ret = iosClient.send_notification_batch(
        notifications, topic='com.guson.q8.voip')
